                      ...
                      <!--  <tr class="table-row">
                           ...
                           <!-- </td>
                            ...
                            <!--</td>
                             ...
                             <td >
								<a href="sveditadhar.php"><i class="fa fa-pencil icon-pencil"></i></a>
                       ...
                       <tr class="table-row">
                            ...
                            <td>
                            	<a class="fam" target="blank" href="uploads/<?php echo $lisence1; ?>">View</a>
                            </td>
                            <td class="march">
                             <!--   in 5 days--> 
                            </td>
                             ...
                             <td >
                               <a href="sveditlisence.php"><i class="fa fa-pencil icon-pencil"></i></a>
                            </td>
                        </tr>
                        <tr class="table-row">
                            <td class="table-img">
                            ...
                            <td>
                            	<a class="fam" target="blank" href="uploads/<?php echo $rc1;?>">View</a>
                            </td>
                            <td class="march">
                                <!--in 5 days--> 
                            </td>
                             ...
                             <td >
                               <a href="sveditrc.php"><i class="fa fa-pencil icon-pencil"></i></a>
                            </td>
                        </tr>
                        <tr class="table-row">
                            <td class="table-img">
                            ...
                            <td>
                            	<a class="fam" target="blank" href="uploads/<?php echo $puc1;?>">View</a>
                            </td>
                            <td class="march">
                              <!--n 4 days--> 
                            </td>
                             ...
                             <td >
                                <a href="sveditpuc.php"><i class="fa fa-pencil icon-pencil"></i></a>
                            </td>
                        </tr>
                        <tr class="table-row">
                            <td class="table-img">
                            ...
                            <td>
                            	<a class="fam" target="blank" href="uploads/<?php echo $insurance1;?>">View</a>
                            </td>
                            <td class="march">
                             <!--   in 4 days--> 
                            </td>
                             ...
                             <td >
                               <a href="sveditinsu.php"><i class="fa fa-pencil icon-pencil"></i></a>
                            </td>
                        </tr>
                    </tbody>
                </table>
